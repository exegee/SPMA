...
namespace SPMA.Migrations
{
    ...
    [Migration("20211207130753_WarehouseItemAddStatusAndParentRWItem")]
    partial class WarehouseItemAddStatusAndParentRWItem
    {
            ...
            modelBuilder.Entity("SPMA.Models.Warehouse.WarehouseItem", b =>
                {
                    ...
                    b.HasOne("SPMA.Models.Production.InProductionRW", "ParentRWItem")
                        .WithMany()
                        .HasForeignKey("ParentRWItemId");
